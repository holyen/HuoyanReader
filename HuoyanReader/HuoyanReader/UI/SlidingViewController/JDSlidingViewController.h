...
typedef enum {
    ...
    RESET_PAN = ECPanning
} JDSlidingResetMethod;

@interface JDSlidingViewController : ECSlidingViewController
...
@property (nonatomic, assign) JDSlidingBackViewLayout leftBackViewLayout;

@property (nonatomic, assign) JDSlidingBackViewLayout rightBackViewLayout;

@property (nonatomic, assign) JDSlidingResetMethod resetMethod;

- (UIPanGestureRecognizer *)panGesture;

- (void)anchorFrontViewTo:(JDSlidingSide)side;

- (void)anchorFrontViewTo:(JDSlidingSide)side animations:(void(^)())animations
...
@interface UIViewController (JDSlidingViewController)
